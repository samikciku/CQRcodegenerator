...
const BarcodeTextOptions = ({ textOptions, setTextOptions }) => {
    ...
    <div className="bg-white rounded-lg shadow-sm border p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="show-barcode-text" className="ml-2 block text-sm text-gray-700">
            Add text above/below barcode
          </label>
        </div>
          ...
          <>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Text will appear above and/or below the barcode without interfering with its scanning capability.
              </p>
            </div>
          </>
        )}
